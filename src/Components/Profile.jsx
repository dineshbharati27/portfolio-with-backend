    ...
    <>
      {show ? (
        <div
          ...
          } lg:w-11/12  md:w-8/12 sm:w-6/12 absolute sm:left-[150px] sm:top-[110px] z-20`}
        >
          <NavLink to="/">
            <div
              onClick={handleCross}
      ...
      <div className="w-full flex justify-around">
        ...
        >
          <div className="w-40 h-40 rounded-full  image">
            <img src={assets.myPhoto} className="w-screen rounded-lg" />
          </div>
          <h1
            className={`text-2xl mt-2 font-bold relative lg:top-16 sm:top-24 ${
              bgcolor === "white" ? "text-black" : "text-white"
            }`}
          >
            Dinesh Bharati
          ...
          <div
            className="passion w-6/13 h-8 p-1 relative lg:top-12 sm:top-20"
            style={{
              background: `${bgcolor === "white" ? "#f3f6f6" : "#1D1D1D"}`,
            }}
          >
          ...
          <div className=" w-96 flex gap-3 justify-center relative lg:top-10 sm:top-14">
            {/* <div
            ...
            >
              <a href="https://www.linkedin.com/in/dinesh-bharati">
                {" "}
            ...
            >
              <a href="https://github.com/dineshbharati27" target="#">
                {" "}
